    ...
    <Layout>
      <div className="flex flex-col gap-3 mr-3">
        ...
        <div className="flex flex-row gap-2">
          ...
          <div className="bg-white shadow-md p-4 rounded-md mb-4 w-2/3">
            <div className="flex flex-row justify-between items-center">
          ...
          {/* Low Quantity Stock */}
          <div className="bg-white shadow-md p-4 rounded-md mb-4 w-1/3">
            <div className="flex flex-row justify-between items-center pb-2">
              <h1 className="text-lg pb-2 tracking-wide">Low Quantity Stock</h1>
              <p className="text-blue-500">See All</p>
            </div>
            <div className="flex flex-col gap-4">
              <div className="flex flex-row justify-between items-center gap-3">
                ...
                <div className="rounded-xl bg-red-300 p-1.5 text-xs text-red-600 font-semibold">
                  Low
                </div>
              </div>
              <div className="flex flex-row justify-between items-center gap-3">
